...
function About() {
 ...
 {/* couseAbouts Section (Detailed Approach) */}
 <section className="couseAbouts-section">
 <div className="couseAbouts-container">
 {aboutDetailedContent.map((couseAbout, i) => (
 <div
 key={i}
 className={`couseAbout-block ${couseAbout.reverse ? "reverse" : ""}`}
 >
 <div className="couseAbout-content">
 <h2 className="couseAbout-heading">{content[couseAbout.headingKey]}</h2>
 <p className="couseAbout-description">
 {content[couseAbout.descriptionKey]}
 </p>
 </div>
 <div className="couseAbout-image">
 <img
 src={couseAbout.img}
 alt={content[couseAbout.headingKey]}
 />
 </div>
 </div>
 ))}
